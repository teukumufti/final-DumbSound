      ...
      {userTrans?.status === "success" ? (
        <div className="transaction-container d-flex flex-1 flex-column">
          ...
          <div className="d-flex flex-1 align-items-center text-center justify-content-center flex-column text-white mx-2">
            ...
            <h1 className="my-5 fw-700 fs-1 text-orange">
              You already premium
            </h1>
            <p className="lh-lg mb-4">
              Now you can play music as you want <br />{" "}
              <span className="fs-8">If any problem please contact admin</span>{" "}
              <br />
              <span className="text-orange fw-bold">DUMB</span>
              <b>SOUND: 098131222232</b>
            </p>
            {/* <button type="submit" className="bg-orange px-5 py-3 text-white fw-500 py-2 borra-3" onClick={handleBuy}>Bayar Sekarang</button> */}
          </div>
        </div>
      ) : userTrans === null ||
        userTrans?.status === "failure" ||
        userTrans?.status === "failed" ? (
        <div className="transaction-container d-flex flex-1 flex-column">
          <NavbarUser />
          <div className="d-flex flex-1 align-items-center text-center justify-content-center flex-column text-white mx-2">
            ...
            <p className="lh-lg mb-4">
              ...
              <span className="text-orange fw-bold">DUMB</span>
              <b>SOUND</b>
              <br /> <span className="text-orange fw-bold">DUMB</span>
              <b>SOUND: 098131222232</b>
            </p>
            <p className="m-1">
              Hanya <b>Rp.120.000/Bulan</b>
            </p>
            <button
              type="submit"
              className="bg-orange px-5 py-3 text-white fw-500 py-2 borra-3"
              onClick={handleBuy}
            >
              Bayar Sekarang
            </button>
          ...
          <div className="transaction-container d-flex flex-1 flex-column">
            ...
            <div className="d-flex flex-1 align-items-center text-center justify-content-center flex-column text-white mx-2">
              ...
              <p className="lh-lg mb-4">
                ...
                <span className="fs-8">Please wait a moments</span> <br />
                <span className="text-orange fw-bold">DUMB</span>
                <b>SOUND: 098131222232</b>
              </p>
              <button
                type="submit"
                className="btn btn-outline-light text-orange px-5 py-2 fw-500 py-2 borra-3"
                onClick={handleBuy}
              >
                Try payment
              </button>
